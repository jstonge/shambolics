...
As computing becomes more affordable, data more accessible, and the Web continues to grow, a growing number of scientists are shifting towards computational approaches. But the adoption of computational practices is not evenly distributed. Our concern is the potential negative effects on the future of science that the relative cost-benefits of adopting computational practices may have. Knowing that gender-bias in society increase the chance of male working with computers early on, or that researchers at prestigious institutions benefit significantly from advanced digital infrastructure, we expect that nonmeritocratic factors will exert a greater influence on the dissemination of ideas with the rise of computational science, accruing the success of individuals and institutions in proportion to their initial level of wealth.

As there are more and more incentive to code in science, we investigate the tension between individuals and groups in a scientific context.
