...
#### TODO
 - [x] Add the possibility to locate papers containing keywords in title.
 - [ ] Add the possibility to locate a list of selected papers in the dot plot.
 - [x] Add the possibility to locate selected topics in the dot plot.
 - [x] Add the possibility to locate papers from selected years.
 - [ ] Add the possibility to locate papers from selected venues.
 - [x] Add a table that we can filter based on selected topics and/or title.
