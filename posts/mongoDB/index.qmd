...
Key refs:
 ...
 - `install mongosh:` [mongodb-zsh/install/](https://www.mongodb.com/docs/mongodb-zsh/install/)
 ...
 - `Update documents`: [mongodb-zsh/crud/update/](https://www.mongodb.com/docs/mongodb-zsh/crud/update/)
 - `Queries`:
